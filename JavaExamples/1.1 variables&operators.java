//------------------------------------------------------------------------------------|	
//ПЕРЕМЕННЫЕ 
Type	deafult	value				description						byte bit
byte	0		-128 .. 127			Наименьшее целое — один байт	1	 8	byte	boolean
short	0		-32,768 .. 32,767	Короткое целое, два байта		2	 16	short	char
int		0		— 2*109 .. 2*109	Целое число, 4 байта			4	 32	int		float
long	0L		— 9*1018 .. 9*1018	Длинное целое, 8 байт			8	 64	long	double
float	0.0f	-10127 .. 10127		Дробное, 4 байта
double	0.0d	-101023 .. 101023	Дробное, двойной длины, 8 байт
boolean false	true, false			Логический тип (только true & false)
char	‘\u0000‘ 0..65,535			Символы, 2 байта, все больше 0
Object	null	Любая ссылка		Хранит ссылки на объекты типа Object или классов наследников
