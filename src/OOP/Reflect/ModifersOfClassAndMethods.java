...
public class ModifersOfClassAndMethods {

    public static void main(String[] args) {
        int modifiersOfThisClass = ModifersOfClassAndMethods.class.getModifiers();
    ...
    private static Method getMainMethod() {
        Method[] methods = ModifersOfClassAndMethods.class.getDeclaredMethods();
